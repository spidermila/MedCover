...
def upgrade() -> None:
    ...
    op.add_column(
        "app_settings", sa.Column("notify_event_lifecycle", sa.Boolean(), nullable=False, server_default="true")
    )
    op.add_column(
        "app_settings", sa.Column("notify_event_cancelled", sa.Boolean(), nullable=False, server_default="true")
    )
    op.add_column(
        "app_settings", sa.Column("notify_unfilled_reminder", sa.Boolean(), nullable=False, server_default="true")
    )
