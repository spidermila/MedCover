...
ALL_PERMISSIONS: list[dict] = [
    ...
    {"code": "event.archive_draft", "description": "Archive draft events (archivovat zápisníkové akce)"},
    {"code": "event.archive", "description": "Archive events (archivovat akci)"},
    {"code": "event.unarchive", "description": "Restore events from archive (obnovit akci z archivu)"},
